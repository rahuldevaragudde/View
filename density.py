#
# This script gets occupancy counts from a specific density sensor from start_time to end_time
# Pleaase change the variable names below.
# Space ID for various Density.io sensors are in the
# https://docs.google.com/document/d/1xoS790JzdZcMPTeBhSzv5lWIWfRsi3HriWcN7_Ps2a0/
#
import requests
...
'&interval=' + period + '&page_size=' + pagesize, headers={'Authorization': token})
output = r.json()
results = output['results']
for ts in results:
